...
public class CssSelector2 {
 ...
 public static void main(String[] args) {
  ...
  System.setProperty("webdriver.chrome.driver","C:\\Users\\ustjavasdetb415\\Downloads\\chromedriver_win32\\chromedriver.exe");  
  ...
  // set the browser URL in get() to load the webpage
     ...
     driver.findElement(By.cssSelector("input.button.style1.style2.style3")).click();
